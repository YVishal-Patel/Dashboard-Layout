...
export const MainComponent = () => {
 ...
 return(<>    <div id={idx} className="small-search-data">
              ...
              <Button style={{backgroundColor:item.status=="true"?"lightblue":"lightgrey"}} variant="contained"  className="review-btn">Done</Button>
...
<div className="main-table-text-case text-packs">
          ...
          <div className="error_message_main">
            <div className="error_message">
              <svg className="err-ico" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#F57C00"><path d="M11 15h2v2h-2v-2zm0-8h2v6h-2V7zm.99-5C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></svg>  
              <span className="err_msg"> Test Cases are not modified since user story edit on 20th May 2022</span>
            </div>
          </div>
 ...
 return(<>    <div id={idx} className="small-search-data">
        ...
        <div className="main-table small-tab">
          ...
          <div className="main-table-text-case">
            <span className="text-head">Test Cases</span>
              <div className="main-small-container-data small-data">
            <div className="main-div-table">
                <p className="total-text-data">Total</p>
                <p className="total-text-value">03</p>
              </div>
...
<div className="main-table-text-case text-packs">
          ...
          <div className="main-component-navbar">
            ...
            <div className="main-navbar-right-div">
            <IconButton className="outline-ico" aria-label="delete" color="primary">
            <svg xmlns="http://www.w3.org/2000/svg" className="table-down-ico" height="14px" viewBox="0 0 24 24" width="14px" fill="#FFFFFF"><path d="M0 0h24v24H0z" fill="none"/><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>
